...
layout: full
---              
<span class="fa-pull-left top-of-tutorial-repo-link"><span class="first-word">Full</span>, runnable src of [Get Post Details](https://github.com/dpays/developer-docs-tutorials-rb/tree/master/tutorials/05_get_post_details) can be downloaded as part of the [RB tutorials repository](https://github.com/dpays/developer-docs-tutorials-rb).</span>
<br>
...
1. [Making the api call](#making-the-api-call) - Use dpay-rb to a specific post
...
#### Example api call
If we want to get the post "announcing-the-dpay-developer-portal" by user @dsitedev
```ruby
api.get_content("dsitedev", "announcing-the-dpay-developer-portal") do |content| ...
```

#### Example api call using script
And to do the same with our tutorial script
```bash
ruby get_post_details.rb https://dsite.io/dpaydev/@dsitedev/announcing-the-dpay-developer-portal
```
...
```
Post by dsitedev
	title: Announcing the dPay Developer Portal!
	permlink: announcing-the-dpay-developer-portal
	category: dpaydev
	...
	payout:
		...
		percent_dpay_dollars: 100.00 %
		payout at: 2017-11-06T16:34:27 (235.2 days ago)
		author_rewards: 0.000 BBD
...
* `1000000.000 BBD` - Accepted Payout
* `0.000 BBD` - Declined Payout

In addition to `max_accepted_payout`, the author may specify how much of the author reward should be in BEX Power or liquid rewards.  The most common settings are:
...
Some content will have a `beneficiaries` array.  This is used to determine reward routes any account, up to eight.  Payouts are in BEX Power and are expressed as a reward percentage of the author reward.
