...
layout: full
---              
<span class="fa-pull-left top-of-tutorial-repo-link"><span class="first-word">Full</span>, runnable src of [Submit Post](https://github.com/dpays/developer-docs-tutorials-rb/tree/master/tutorials/10_submit_post) can be downloaded as part of the [RB tutorials repository](https://github.com/dpays/developer-docs-tutorials-rb).</span>
<br>
...
The response we get after broadcasting the transaction gives us the transaction id ([`768f7f6...`](https://bex.network/tx/768f7f64cee94413da0017ef79f592bb4da86baf)), block number ([`22867626`](https://bex.network/b/22867626)), and the transaction number of that block (`43`).
