  ...
  module TutorialsJob
    class Base
      ...
      def initialize(options = {})
        ...
        @tutorial_github_url = options[:tutorial_github_url] #e.g.: https://github.com/dpays/developer-docs-tutorials-js.git
        @tutorial_github_name = options[:tutorial_github_name] # e.g.: devportal-tutorials-js
        @tutorial_url = options[:tutorial_url] # e.g.: https://github.com/dpays/developer-docs-tutorials-js
