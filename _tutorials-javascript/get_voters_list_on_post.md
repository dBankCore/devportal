...
layout: full
---              
<span class="fa-pull-left top-of-tutorial-repo-link"><span class="first-word">Full</span>, runnable src of [Get Voters List On Post](https://github.com/dpays/developer-docs-tutorials-js/tree/master/tutorials/06_get_voters_list_on_post) can be downloaded as part of the [JS tutorials repository](https://github.com/dpays/developer-docs-tutorials-js).</span>
<br>
...
*   `reputation` - The [reputation](https://developers.dpays.io/glossary/#reputation) of the account that voted.
